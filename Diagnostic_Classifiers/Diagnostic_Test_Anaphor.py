...
if __name__ == "__main__":
    ...
    glove_list, bert_list = RSA.preprocess_data('../Binding_Theory/Anaphor/anaphor_corpus.txt', noun_list)
    ...
    nonant_data, ant_data = get_diagnostic_input(glove_list, glove, word2idx, bert_embeds, anaphor=True)
    ...
    print(f'Non-Antecedent Accuracy: {accuracy_score(nonant_test_y, nonant_preds)}\nNon-Antecedent Precision: {precision_score(nonant_test_y, nonant_preds)}\nNon-Antecedent Recall: {recall_score(nonant_test_y, nonant_preds)}')
